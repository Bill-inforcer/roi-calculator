...
Replace the default numbers with the partner's own; the model recalculates on every keystroke.

A toggle reveals internal PSM talking points keyed off the live numbers — hide before sharing the URL with a partner.
